function sha256Fallback(text) {
  ...
  const zeroCount = (55 - (raw.length % 64) + 64) % 64;
  const withPad =
    raw +
    String.fromCharCode(0x80) +
    "\0".repeat(zeroCount) +
    String.fromCharCode(
      ...[0, 0, 0, 0, (bitLen >>> 24) & 255, (bitLen >>> 16) & 255, (bitLen >>> 8) & 255, bitLen & 255]
    );
  let h0 = 0x6a09e667,
    h1 = 0xbb67ae85,
    h2 = 0x3c6ef372,
...
/** SHA-256 hex digest; uses Web Crypto when available, else a pure-JS fallback. */
