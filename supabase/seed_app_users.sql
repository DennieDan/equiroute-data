...
insert into public.app_users (external_id, username, password_hash, display_name, role, organization, persona_hint, metadata) values
  ...
  ('google_public_demo', 'google.public.demo', 'demo-password-public', 'Google public demo user', 'public', 'Google account demo', 'visually_impaired', '{"demo_user":true,"google_demo":true,"username":"google.public.demo","needs":"public feedback flow without disabled OAuth provider"}'::jsonb),
